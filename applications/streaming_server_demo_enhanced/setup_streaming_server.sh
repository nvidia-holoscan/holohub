...
NGC_RESOURCE="nvidia/holoscan/holoscan_server_cloud_streaming:1.0"
...
print_summary() {
    ...
    echo "     ./holohub build streaming_server_demo_enhanced"
    echo
    echo "  2. Run the streaming server application:"
    echo "     ./holohub run streaming_server_demo_enhanced --language cpp"
    echo
    echo "  3. Or run with custom resolution:"
    echo "     python applications/streaming_server_demo_enhanced/python/streaming_server_demo.py --width 1280 --height 720"
    echo
}
