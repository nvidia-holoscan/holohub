...
from riva.client.audio_io import get_default_input_device_info
...
class ASR_LLM_TTS(Application):
    ...
    llm chatbot, whose reponse is then converted to speech using Riva TTS. This app includes a
    ...
    def compose(self):
        ...
        # Limits the noisy output from the webserver when debuggging
...
def main():
    ...
    if not args.sample_rate_hz:
        args.sample_rate_hz = sample_rate = int(
