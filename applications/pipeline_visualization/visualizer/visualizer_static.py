...
class Visualizer:
    ...
    def __init__(self):
        ...
        @self._app.callback(
            [
                Output("source-out", "children"),
                Output("modulate-in", "children"),
                Output("modulate-out", "children"),
                Output("sink-in", "children"),
            ],
        ...
        def update_source(n_intervals, subject):  # noqa: ARG001
            ...
            This callback is triggered by the interval component (every 500ms) and:
            ...
            while not done:
                ...
                patches[index][1]["props"]["figure"]["data"][0]["y"] = data
