...
class SourceOp(Operator):
    ...
    def compute(self, op_input, op_output, context):
        ...
        wave = wave.reshape(samples, 1).astype(np.float32)
...
class ModulateOp(Operator):
    ...
    def compute(self, op_input, op_output, context):
        ...
        modulated_signal = modulated_signal.astype(np.float32)
...
class SinkOp(Operator):
    ...
    def compute(self, op_input, op_output, context):
        ...
        _tensor = next(iter(op_input.receive("in").values()))
