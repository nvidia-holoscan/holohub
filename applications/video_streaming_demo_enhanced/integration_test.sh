...
./holohub test video_streaming_demo_enhanced --base-img=nvcr.io/nvidia/clara-holoscan/holoscan:v3.5.0-dgpu --build-args="--build-arg BASE_SDK_VERSION=3.5.0" --cmake-options="-DBUILD_TESTING=ON" --ctest-options="-R streaming.*test" 2>&1 > applications/video_streaming_demo_enhanced/integration_test.log
