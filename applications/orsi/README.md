...
[In and out of body detection and anonymization of surgical video sample app](./orsi_in_out_body/README.md):
...
#### 1. orsi_in_out_body (build)

```bash
./holohub build orsi_in_out_body
```

#### 2. orsi_segmentation_ar (build)

```bash
./holohub build orsi_segmentation_ar
```

#### 3. orsi_multi_ai_ar (build)
