 ...
 public:
  ...
  void compute(InputContext& op_input, OutputContext& op_output,
    ...
    */
    ...
    add_data<TORUS_MAJOR_SEGMENTS * TORUS_MINOR_SEGMENTS * 6, 3>(entity,  // 6 vertices per quad (2 triangles × 3 vertices)
    "torus",
    torus_array,
    context);
    ...
    */
    ...
    HolovizOp::InputSpec torus_spec = XrViewsHelper::create_spec_with_views(
        "torus",
        HolovizOp::InputType::TRIANGLES_3D,
        located_views,
        xr_session,
        model_matrix);
...
class HolovizGeometryApp : public holoscan::Application {
    ...
    void compose() override {
        ...
        auto xr_manager = make_resource<holoscan::XrManager>("xr_manager", Arg("xr_session") = xr_session);
        ...
        // TODO: width and height are hardcoded for now, can't get the width and height from headset at this point
        ...
        auto buffer_composition = make_operator<ops::XrBufferCompositionOp>("buffer_composition", Arg("xr_manager") = xr_manager);
        ...
        add_flow(visualizer, buffer_composition, {{"render_buffer_output", "color_render_buffer_output"}});
