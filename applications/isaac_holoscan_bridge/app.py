...
class IsaacSimHoloscan:
    """A class that integrates IsaacSim with Holoscan for simulation and data processing.

    This class manages the coordination between an IsaacSim simulator and a Holoscan transformer
    ...
    def run(self):
        ...
        This method:
        1. Initializes and starts the IsaacSim simulator
        ...
        self._simulator = Simulator(
            self._args.headless,
            (self._args.image_height, self._args.image_width, 4),
            self._args.fps,
        )
