...
def run_training(ingestion_dir, output_dir, training_iterations, coarse_iterations, use_masks, use_deformation=True):
    ...
    Args:
        ...
        use_deformation: Enable deformation network (False for static scene)
...
def main():
    ...
    print(f"Deformation: {'Disabled (static)' if args.no_deformation else 'Enabled (dynamic)'}")
    print(f"{'='*70}\n")
