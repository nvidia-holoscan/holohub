...
![Holoscan Stereo Vision demo](./images/plants.gif)
...
The `stereo-plants.mp4` video is provided in the [Holoscan stereo video NGC catalog](https://catalog.ngc.nvidia.com/orgs/nvidia/teams/clara-holoscan/resources/holoscan_stereo_video) and will be downloaded and converted to the necessary format when building the application.
...
you build the devcontainer with a compatible `base_img` as shown in the **Build and Run Instructions** section.
