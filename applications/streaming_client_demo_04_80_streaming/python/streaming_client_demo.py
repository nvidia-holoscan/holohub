...
# Import HoloHub streaming client operator
try:
    from holohub.streaming_client import StreamingClientOp
except ImportError as e:
    print(f"Error importing StreamingClientOp: {e}")
    print("Make sure the HoloHub streaming_client operator is built and installed.")
    raise

class StreamingClientTestApp(Application):
    """Example application to test the StreamingClientOp operator."""

    def __init__(self, server_ip="127.0.0.1", signaling_port=48010, width=1920, height=1080, fps=30):
