...
class AdvNetworkingBenchRmaxTxOp : public Operator {
 public:
  HOLOSCAN_OPERATOR_FORWARD_ARGS(AdvNetworkingBenchRmaxTxOp)

  AdvNetworkingBenchRmaxTxOp() = default;

  ~AdvNetworkingBenchRmaxTxOp() {
  ...
  void initialize() override {
    HOLOSCAN_LOG_INFO("AdvNetworkingBenchRmaxTxOp::initialize()");
    ...
    HOLOSCAN_LOG_INFO("AdvNetworkingBenchRmaxTxOp::initialize() complete");
  }
