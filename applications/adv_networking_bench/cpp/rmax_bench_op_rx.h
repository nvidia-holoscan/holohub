...
class AdvNetworkingBenchRmaxRxOp : public Operator {
 public:
  HOLOSCAN_OPERATOR_FORWARD_ARGS(AdvNetworkingBenchRmaxRxOp)

  AdvNetworkingBenchRmaxRxOp() = default;

  ~AdvNetworkingBenchRmaxRxOp() {
  ...
  void initialize() override {
    ...
    HOLOSCAN_LOG_INFO("AdvNetworkingBenchRmaxRxOp::initialize()");
    ...
    HOLOSCAN_LOG_INFO("AdvNetworkingBenchRmaxRxOp::initialize() complete");
  }
  void freeResources() {
    HOLOSCAN_LOG_INFO("AdvNetworkingBenchRmaxRxOp::freeResources() start");
    for (int n = 0; n < num_concurrent; n++) {
    ...
    HOLOSCAN_LOG_INFO("AdvNetworkingBenchRmaxRxOp::freeResources() complete");
  }
