...
The Holoviz operator parameter `display_color_space` is used to set the color space. This allows HDR output on Linux distributions and displays supporting that feature. See <https://docs.nvidia.com/holoscan/sdk-user-guide/operators/visualization#hdr> for more information.
