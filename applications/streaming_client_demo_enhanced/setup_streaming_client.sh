...
extract_and_setup() {
    ...
    if [[ ! -d "streaming_client_enhanced/$EXTRACT_DIR" ]]; then
        print_error "Expected directory not found after extraction: streaming_client_enhanced/$EXTRACT_DIR"
    ...
    mv "streaming_client_enhanced/$EXTRACT_DIR" .
    
    # Clean up the temporary extraction directory
    rm -rf "streaming_client_enhanced"
...
print_summary() {
    ...
    echo "     ./holohub build streaming_client_demo_enhanced"
    echo
    echo "  2. Configure your camera in the YAML file:"
    echo "     applications/streaming_client_demo_enhanced/cpp/streaming_client_demo.yaml"
    echo
    echo "  3. Run the streaming client application:"
    echo "     ./holohub run streaming_client_demo_enhanced --language cpp"
    echo
