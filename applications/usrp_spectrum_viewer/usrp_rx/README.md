...
- `channels`, `dest_ports`: channel-to-port mapping for outgoing UDP streams.
- `dest_addr`, `adapter`, `dest_mac_addr`, `keep_hdr`, `spp`, `mtu`: streaming format and egress configuration.
