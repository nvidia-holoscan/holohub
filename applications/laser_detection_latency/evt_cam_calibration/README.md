...
1. Follow the [Holoscan SDK user guide](https://docs.nvidia.com/holoscan/sdk-user-guide/setup/third-party-hardware-setup/emergent-setup) to set up the EVT camera
