...
1. **[Laser Detection app](./laser_detection):**
...
Visit the [Emergent Vision Technologies setup guide](../../operators/emergent_source/setup.md) to check the hardware requirements for EVT camera.
...
To setup the EVT camera, refer to the [Emergent Vision Technologies setup guide](../../operators/emergent_source/setup.md).
