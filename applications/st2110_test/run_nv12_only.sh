#!/bin/bash
# Test 3: NV12 Only Configuration
...
echo "========================================"
echo "Test 3: NV12 Only (RGBA Disabled)"
echo "========================================"
echo ""
...
docker run --rm --runtime=nvidia --network=host \
  ...
  bash -c "cd /workspace/applications/st2110_test && python3 st2110_test_app.py --config st2110_test_config_nv12_only.yaml"
