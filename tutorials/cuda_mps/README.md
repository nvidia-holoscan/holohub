...
`echo quit | nvidia-cuda-mps-control` command. More control commands are described in the [CUDA MPS control commands documentation](https://docs.nvidia.com/deploy/mps/index.html#topic_5_1).
...
environment variable separately for each application. It is elaborated in details in the [per-application thread percentage documentation](https://docs.nvidia.com/deploy/mps/index.html#topic_5_2_5).
...
| --- | --- |
| ![99.9th percentile latency](images/igx-dgpu/multiple_inference_7/99.9th%20Percentile%20Latency%20(ms).png) | ![99th percentile latency](images/igx-dgpu/multiple_inference_7/99th%20Percentile%20Latency%20(ms).png) |
