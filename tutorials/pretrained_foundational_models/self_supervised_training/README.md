...
* ResNet18        - [ResNet18 checkpoint](https://drive.google.com/file/d/17w_LEI36JrHcUf5fGEufpyZaIk3Fp1Co/view?usp=sharing)
* ResNet50        - [ResNet50 checkpoint](https://drive.google.com/file/d/1fK87Nxit5bokYuMCbMG1cEHmEZUGBDlA/view?usp=share_link)
* efficientnet_b0 - [efficientnet_b0 checkpoint](https://drive.google.com/file/d/1rgolweQ5HU6Kvf93jqLkaLVKE8DD_Aco/view?usp=sharing)

### Tool Segmentation Model

* MONAI - FlexibleUNet (efficientnet_b0) - [Tool segmentation model checkpoint](https://drive.google.com/file/d/1HLyccYY0AtZy8Sr1ty-gid-Fee4DVjWM/view?usp=share_link)
...
NeurIPS 2021 ([paper](https://arxiv.org/abs/2006.10029)).
...
([paper](https://arxiv.org/abs/2207.00449))
