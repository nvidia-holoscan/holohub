...
=== "tune_system.py"
    ...
    === "Debian installation"
        ...
        ```bash
        sudo /opt/nvidia/holoscan/bin/tune_system.py --check gpudirect
        sudo /opt/nvidia/holoscan/bin/tune_system.py --check peermem
        ```
    ...
    ??? abstract "See an example output"
        ...
        The available GPU is able of GPUDirect, but the kernel module to enable it is not loaded.

        ```log
        2025-03-12 14:15:07 - INFO - GPU 0: NVIDIA RTX A6000 has GPUDirect support.
        2025-03-12 14:15:27 - WARNING - nvidia-peermem module is not loaded. GPUDirect may not work.
        ```
...
=== "Manual"
    ...
    ??? abstract "See an example output"
        ...
        The kernel module is present, therefore loaded.

        ```log hl_lines="1"
        nvidia_peermem         16384  0
        nvidia               7745536  188 nvidia_uvm,nvidia_peermem,nvidia_modeset
        ib_uverbs             184320  3 nvidia_peermem,rdma_ucm,mlx5_ib
        ```
