...
| `HOLOSCAN_CLI_BASE_SDK_VERSION` | Holoscan SDK version used for default container base image selection. Defaults to `4.6.0`; override it to match your project. |
