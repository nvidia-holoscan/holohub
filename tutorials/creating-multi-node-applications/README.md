...
![Endoscopy tool tracking app graph](./images/endoscopy_tool_tracking_app_graph.png)
The app graph for `endoscopy_out_of_body_detection`:
![Endoscopy out of body app graph](./images/endoscopy_out_of_body_app_graph.png)
The distributed app graph we want to create:
![Scenario 2 distributed app graph](./images/scenario2_distributed_app_graph.png)
...
![Two IGX Orin Developer Kits connected via QSFP](./images/Two%20IGX%20Connection.png)
