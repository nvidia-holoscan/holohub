...
def main():
    ...
    parser.add_argument('--iterations', type=int, help="The number of iterations to run for each experiment. Default = 10", default = 10)
    ...
    parser.add_argument('--numvars', type=int, help="The number of variations to use for each graph. Default = 10", default = 10)
