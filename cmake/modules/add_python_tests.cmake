...
function(add_python_tests)
  ...
  set(PYTEST_IGNORE_ROOT_STR "--rootdir=${PYTEST_WORKING_DIRECTORY} --confcutdir=${PYTEST_WORKING_DIRECTORY}")

  # Get the list of tests from pytest
  set(pytest_collect_cmd "${Python3_EXECUTABLE} -m pytest ${PYTEST_WORKING_DIRECTORY}/${PYTEST_INPUT} --collect-only ${PYTEST_IGNORE_ROOT_STR}")
  ...
  foreach(test_line ${pytest_list})
    ...
    if(test_line MATCHES "(.+)::([^\\[]+)(\\[.+\\])?$")
      ...
      set(PYTEST_CMD "${Python3_EXECUTABLE} -m pytest ${PYTEST_IGNORE_ROOT_STR} ${test_line} ${PYTEST_ARGS_STR}")
