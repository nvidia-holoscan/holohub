...
def install_cuda_dependencies_package(package_name: str, preferred_version: str, optional: bool = False, dry_run: bool = False) -> bool:
    ...
    try:
        ...
        if not matching_version:
            if optional:
                ...
                fatal(f"{package_name} {preferred_version} is not installable.\n"
        ...
        run_command(['sudo', 'apt', 'install', '--no-install-recommends', '-y', f'{package_name}={matching_version}'], dry_run=dry_run)
        return True
