...
#ifndef PYHOLOHUB_OPERATORS_ADV_NET_TX_PYDOC_HPP
#define PYHOLOHUB_OPERATORS_ADV_NET_TX_PYDOC_HPP
...
namespace AdvNetworkOpTx {

PYDOC(AdvNetworkOpTx, R"doc(
iCardio Multi-AI demo application visualization operator.
)doc")

// PyAdvNetworkOpTx Constructor
PYDOC(AdvNetworkOpTx_python, R"doc(
iCardio Multi-AI demo application visualization operator.
