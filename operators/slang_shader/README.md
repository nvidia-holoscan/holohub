...
- **IGX Thor iGPU platform**: Not supported. This is a limitation of the current operator
  ...
  application built on `SlangShaderOp`, such as [`GammaCorrectionOp`](../gamma_correction/README.md).
...
5. **`the provided PTX was compiled with an unsupported toolchain. (222)`**: The PTX generated by
   ...
   limitation on the IGX Thor iGPU platform, which is not supported by this operator. Run on a supported
