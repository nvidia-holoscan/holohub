...
The Prohawk SDK should be installed in the default location:

- **SDK Path**: `/usr/local/phruntime`
- **Library Path**: `/usr/lib` or SDK directory
- **Header Files**: `PTGDE/CPTGDE.h`
...
1. **Clone the Repository**
   ...
   cd holohub/operators/prohawk_video_processing
   ```
...
3. **Configure with CMake**
   ...
   ```bash
   cmake .. \
     -DHOLOSCAN_SDK_PATH=/opt/nvidia/holoscan \
