...
#ifndef HOLOSCAN__GSTREAMER__GST_SINK_OP_HPP
#define HOLOSCAN__GSTREAMER__GST_SINK_OP_HPP
 ...
 */
class GstSinkOp : public Operator {
 public:
  HOLOSCAN_OPERATOR_FORWARD_ARGS(GstSinkOp)
...
#endif /* HOLOSCAN__GSTREAMER__GST_SINK_OP_HPP */
