...
class HoloscanGrpcApplication(Application):
    ...
    @property
    def grpc_request_op(self):
        return self._grpc_request_op

    @property
    def grpc_response_op(self):
    ...
    def __init__(self, incoming_request_queue: Queue, outgoing_response_queue: Queue):
        super().__init__()
        self.name = "gRPC Application"
        self._grpc_request_op = None
        self._grpc_response_op = None
        self._composed = False
        self._request_queue = ConditionVariableQueue(
        ...
        self.cuda_stream_pool = CudaStreamPool(
            self,
            name="cuda_stream",
            dev_id=0,
            stream_flags=0,
    ...
    def set_scheduler(self, config_name):
