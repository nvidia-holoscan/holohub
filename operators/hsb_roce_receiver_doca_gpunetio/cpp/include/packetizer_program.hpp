...
#ifndef HOLOHUB_HSB_ROCE_RECEIVER_DOCA_PACKETIZER_PROGRAM_SHIM
#define HOLOHUB_HSB_ROCE_RECEIVER_DOCA_PACKETIZER_PROGRAM_SHIM
...
#endif /* HOLOHUB_HSB_ROCE_RECEIVER_DOCA_PACKETIZER_PROGRAM_SHIM */
