...
tapnext = TapNextInferenceOp(
    ...
    output_tensor_names_init=["tracks", "visibles", "state"],
    output_binding_names_init=["tracks", "visibles", "state"],
    input_tensor_names_fwd=["video", "query_points", "state"],
    input_binding_names_fwd=["video", "query_points", "state"],
    output_tensor_names_fwd=["tracks", "visibles", "state"],
    output_binding_names_fwd=["tracks", "visibles", "state"],
