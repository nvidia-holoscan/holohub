...
export CMAKE_PREFIX_PATH=/opt/nvidia/holoscan:$CMAKE_PREFIX_PATH
```
...
export CMAKE_PREFIX_PATH=/opt/nvidia/holoscan
```
...
3. Run the demo application to verify reception
