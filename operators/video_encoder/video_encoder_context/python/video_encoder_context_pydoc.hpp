...
#ifndef PYHOLOHUB_OPERATORS_VIDEO_ENCODER_CONTEXT_PYDOC_HPP
#define PYHOLOHUB_OPERATORS_VIDEO_ENCODER_CONTEXT_PYDOC_HPP
...
namespace VideoEncoderContext {

PYDOC(VideoEncoderContext, R"doc(
