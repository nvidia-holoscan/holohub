...
# =============================================================================
# NVIDIA Holoscan Streaming Server Library Setup Script
# =============================================================================
# This script automates the download and setup of streaming server libraries
# for the streaming_server operator in HoloHub.
#
...
NGC_RESOURCE="nvidia/holoscan_server_cloud_streaming:0.1"
ZIP_FILE="holoscan_server_cloud_streaming_v0.1/holoscan_server_cloud_streaming.zip"
EXTRACT_DIR="holoscan_server_cloud_streaming_v0.1"
...
verify_installation() {
    ...
    local key_libs=("libStreamingServer.so" "libNvStreamBase.so")
...
${GREEN}=== NEXT STEPS ===${NC}
1. The streaming server libraries are now ready to use
2. You can build the streaming_server operator with CMake
...
main() {
    ...
    echo -e "${BLUE}=== NVIDIA Holoscan Streaming Server Library Setup ===${NC}"
    echo ""
    ...
    print_success "Streaming server library setup completed successfully!"
}
